...
function buildExplainer() {
  return el('section', { className: 'explainer' }, [
    ...
    el('p', {}, [
      'These distortions are regularly weaponised. In 2019, a county-level map of the ',
      '2016 US election was ',
      ...
      ' \u2014 a sea of red that obscured the fact Clinton won the popular vote by 2.8\u00a0million. ',
      'Several counties were even ',
      ...
      '. After the 2022 Pennsylvania Senate race, a similar county map ',
      el('a', { href: 'https://www.politifact.com/factchecks/2022/nov/10/instagram-posts/map-does-not-prove-pennsylvania-election-was-rigge/', target: '_blank', rel: 'noopener' }, ['went viral on social media']),
      ' as supposed proof the election was rigged \u2014 ignoring that Fetterman\u2019s ',
      'handful of blue counties contained far more voters than Oz\u2019s fifty-plus red ones combined. ',
      'The same misleading format ',
      ...
      ', this time shared by an official government account. As researchers have ',
